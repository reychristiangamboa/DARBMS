 ...
 */
@WebServlet(name = "ProvOfficeRefresh", urlPatterns = {"/ProvOfficeRefresh"})
public class ProvOfficeRefresh extends BaseServlet {
    ...
    protected void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            response.getWriter().write("<select class='form-control' name='province' id='provinceDrop' style='width: 100%'>");

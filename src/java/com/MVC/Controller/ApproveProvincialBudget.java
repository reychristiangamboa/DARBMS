 ...
 */
public class ApproveProvincialBudget extends BaseServlet {
    ...
    protected void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        p.setApprovedByRegional((Integer)session.getAttribute("userID"));
        
        if(type.equalsIgnoreCase("APCP")){
            addressDAO.approveProvincialAPCPBudget(p);
        }else{
            addressDAO.approveProvincialCAPDEVBudget(p);
        }

 ...
 * @author ijJPN
 */
public class FilterRegionalCAPDEVProposals extends BaseServlet {

    @Override
    protected void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {

        if (request.getParameter("selectAll") != null) { // IS CHECKED
            request.getRequestDispatcher("regional-field-officer-view-capdev-proposals.jsp").forward(request, response);
        } else {
            ...
            request.getRequestDispatcher("regional-field-officer-view-filtered-capdev-proposals.jsp").forward(request, response);
        }

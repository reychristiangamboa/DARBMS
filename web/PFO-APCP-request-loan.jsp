    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <%
                ...
                ArrayList<LoanReason> refLoanReasonsCropProduction = apcpRequestDAO.getAllLoanReasonsByAPCPType(1); // Crop Production Reasons
                ArrayList<LoanReason> refLoanReasonsLivelihoodProgram = apcpRequestDAO.getAllLoanReasonsByAPCPType(2); // Livelihood Program Reasons
                ArrayList<LoanTerm> refLoanTerms = apcpRequestDAO.getAllLoanTerms();
                ArrayList<APCPRequest> refApcpTypes = apcpRequestDAO.getAllAPCPTypes();
                ArrayList<APCPRequest> cropProds = apcpRequestDAO.getAllCropProdByRequest(arboID);
            %>
                    ...
                    <div class="box box-default">
                        ...
                        <form method="post">
                            <div class="box-body">
                                ...
                                <div class="row" id="apcpTypeWrapper" style="margin-top: 10px">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>APCP Type</label>
                                            <select class="form-control" name="apcpType" id="apcpType">
                                                <%for(APCPRequest type : refApcpTypes){%>
                                                <option value="<%out.print(type.getApcpType());%>"><%out.print(type.getApcpTypeDesc());%></option>
                                                <%}%>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" step=".1" class="form-control" name="landArea" id="Area" required>
                                        </div>
                                        <!-- /.form-group -->
                                    </div>
                                    <div class="col-md-3">

                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <h2 class="page-header">
                                    <i class="fa fa-globe"></i> Agrarian Reform Beneficiary Organization (ARBO) Dashboard
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div class="nav-tabs-custom">
                                            <ul class="nav nav-tabs">
                                                <li class="active"><a href="#gender" data-toggle="tab">Average Approval Rate</a></li>
                                                <li><a href="#educ" data-toggle="tab">Loan Type Availment</a></li>
                                                <li><a href="#perProv" data-toggle="tab">Loan Reasons</a></li>
                                                <li><a href="#crop" data-toggle="tab">Past Due Reasons</a></li>
                                            </ul>

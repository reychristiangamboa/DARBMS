                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-4">
                                    <div class="box">
                                        <div class="box-header with-border">
                                            <h3 class="box-title">Urgent Flags</h3>
                                            <div class="box-tools pull-right">
                                                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                                                </button>
                                            </div>
                                            ...
                                            <table class="table table-bordered table-striped export">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span class="label label-success bg-red"><%out.print(r.getRequestStatusDesc());%></span></td>
                                                            <%} else if (r.getRequestStatus() == 2) {%>
                                                        <td><%out.print(r.getDateCleared());%></td>
                                                        <td><span class="label label-success bg-blue"><%out.print(r.getRequestStatusDesc());%></span></td>
                                                            <%} else if (r.getRequestStatus() == 3) {%>
                                                        <td><%out.print(r.getDateEndorsed());%></td>
                                                        <td><span class="label label-success bg-purple-active"><%out.print(r.getRequestStatusDesc());%></span></td>
                                                            <%} else if (r.getRequestStatus() == 4) {%>
                                                        <td><%out.print(r.getDateApproved());%></td>
                                                        <td><span class="label label-success bg-yellow"><%out.print(r.getRequestStatusDesc());%></span></td>
                                                            <%} else if (r.getRequestStatus() == 5) {%>
                                                        <td><%out.print(r.getDateApproved());%></td>
                                                        <td><span class="label label-success bg-teal"><%out.print(r.getRequestStatusDesc());%></span></td>
                                                            <%} else if (r.getRequestStatus() == 7) {%>
                                                        <td><%out.print(r.getDateApproved());%></td>
                                                        <td><span class="label label-success bg-olive"><%out.print(r.getRequestStatusDesc());%></span></td>
                                                            <%}%>

                    ...
                    <div class="box box-default">
                        ...
                        <div class="box-body">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" style="border: transparent;">
                                            ...
                                            <input type="text" class="form-control pull-right" id="datepicker" placeholder="May 26, 2018" style="border: transparent; background: transparent;" disabled="true">
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6">
                                    <table id="example1" class="table table-bordered table-striped" style='margin-left: 50px;'>
                                        <tbody>
                                            <tr>
                                                <td style="border: transparent;"><h5> &#9632; &nbsp; Legal Personality Document:</h5></td>
                                                ...
                                                <td  style="border: transparent;">
                                                    <select class="form-control select2 btn btn-warning" style="width: 35%;">
                                            ...
                                            <tr>
                                                ...
                                                <td  style="border: transparent;">
                                                    <select id="validator" class="form-control select2 btn btn-warning" style="width: 35%;">
                                                        <option selected="selected">Action</option>
                                                        <option value="green">Submitted</option>
                                                        <option value="red">Not Submitted</option>
                                                    </select>
                                                    <button type="button" id="green" class="btn btn-success color red"><i class="fa fa-check"></i></button>
                                                    <button type="button" id="red" class="btn btn-danger color green"><i class="fa fa-close"></i></button>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td  style="border: transparent;"><h5> &#9632; &nbsp; Credit Policies Document:</h5></td>
                                                <td  style="border: transparent;">
                                                    <div class="input-group date">
                                                        <div class="input-group-addon">
                                                            <i class="fa fa-calendar"></i>
                                ...
                                <!--<div class="col-md-3">
                                    <div class="form-group">
                                        <label for="exampleInputFile">Loan Agreements (Date Submitted)</label>
                                        <div class="input-group date">
                                            <div class="input-group-addon">
                                                <i class="fa fa-calendar"></i>
                                            </div>
                                        ...
                                        <p class="help-block">*Optional Document</p>
                                    </div>
                                </div>-->
                            </div>
                            <div class="box-header with-border">

    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="wrapper">
            ...
            <%
                ...
                ArrayList<Evaluation> filteredEvaluations = rDAO.getFilteredEvaluationPerARBIDByType(arbID,2,e.getEvaluationStartDate(),e.getEvaluationEndDate());
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        REPORT<small> APCP RATING: <%out.print(arb.getFullName());%></small>
                    </h1>
                </section>
                ...
                <section class="invoice">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <h2 class="page-header">
                                <i class="fa fa-globe"></i> APCP RATING: <%out.print(arb.getFullName());%>
                    ...
                    <div class="row invoice-info">
                        <div class="text-center">
                            <canvas id="lineAPCPRating" style="height:500px"></canvas>
                        </div>
                    </div>
                    <div class="row invoice-info">
                        <div class="col-xs-12">
        ...
        <script>
            ...
            <%String json = chart.getAPCPRating(filteredEvaluations);%>
